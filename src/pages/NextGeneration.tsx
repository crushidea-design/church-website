...
const introImage = '/next-generation-elementary-illustration.png';
const elementaryImage = '/next-generation-elementary-illustration.png';
const youngAdultsIntroImage = '/next-generation-young-adults-binder-illustration.png';
const youngAdultsImage = '/next-generation-young-adults-binder-illustration.png';
...
function NextGenerationTutorialModal({ onClose }: { onClose: () => void }) {
