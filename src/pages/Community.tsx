    ...
    <div className="bg-wood-100 min-h-screen py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12 border-b border-wood-200 pb-6">
          <div>
            <p className="overline-label mb-3">Community</p>
            <h1 className="text-4xl font-serif font-bold text-wood-950 mb-4">소통 게시판</h1>
            ...
            <>
              <ul className="divide-y divide-wood-200">
                {community.data.map((post) => (
                  <li key={post.id}>
                    <Link to={`/post/${post.id}`} className="block hover:bg-wood-50 transition-colors p-8 group">
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          <h3 className="text-xl font-serif font-bold text-wood-950 truncate mb-3 group-hover:underline decoration-gold-500 underline-offset-4">
                            {post.title}
                          </h3>
                        ...
                        <div className="ml-8 flex-shrink-0 flex items-center gap-2 text-wood-500">
              ...
              {community.hasMore && (
                <div className="p-8 border-t border-wood-200 flex justify-center">
                  <button
