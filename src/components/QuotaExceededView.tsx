...
export default function QuotaExceededView() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-wood-50 p-4">
      <div className="max-w-md w-full bg-white rounded-md shadow-xl p-10 text-center border border-wood-200">
        ...
        <div className="space-y-4">
          <button
            className="w-full py-3 bg-wood-900 text-white rounded-md hover:bg-wood-800 transition shadow-md font-bold flex items-center justify-center gap-2"
            onClick={() => {
