...
import { Menu, X, BookOpen, Users, Mail, Home, Info, PenTool, Heart, Bell, Sparkles } from 'lucide-react';
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { name: '다음세대', path: '/next-generation', icon: Sparkles },
      ...
      <header className="bg-wood-50 border-b border-wood-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            {/* Desktop Nav */}
            <nav className="flex max-lg:hidden items-center space-x-3 xl:space-x-6">
